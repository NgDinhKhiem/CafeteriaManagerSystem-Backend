...
class OrderTest {
    ...
    void testOrderConstructorAndGetters() {
        ...
        OrderItem item = new OrderItem(UUID.randomUUID(), "Test Product", "piece", 2, 5.0);
    ...
    void testSumOfItemsInOrder() {
        OrderItem item1 = new OrderItem(UUID.randomUUID(), "Product 1", "piece", 2, 5.0);
        OrderItem item2 = new OrderItem(UUID.randomUUID(), "Product 2", "piece", 3, 7.5);
    ...
    void testSumOfItemsInAllOrders() {
        OrderItem item1 = new OrderItem(UUID.randomUUID(), "Product 1", "piece", 2, 5.0);
        OrderItem item2 = new OrderItem(UUID.randomUUID(), "Product 2", "piece", 3, 7.5);
        OrderItem item3 = new OrderItem(UUID.randomUUID(), "Product 3", "piece", 4, 8.0);
    ...
    void testSumWithNegativeAndZeroQuantitiesAndPrices() {
        OrderItem item1 = new OrderItem(UUID.randomUUID(), "Product 1", "piece", -2, 5.0);
        OrderItem item2 = new OrderItem(UUID.randomUUID(), "Product 2", "piece", 0, 7.5);
        OrderItem item3 = new OrderItem(UUID.randomUUID(), "Product 3", "piece", 3, -8.0);
    ...
    @Test
    void testSumWithZeroQuantities() {
        OrderItem item1 = new OrderItem(UUID.randomUUID(), "Product 1", "piece", 0, 5.0);
        OrderItem item2 = new OrderItem(UUID.randomUUID(), "Product 2", "piece", 0, 7.5);
        OrderItem item3 = new OrderItem(UUID.randomUUID(), "Product 3", "piece", 3, 8.0);
        Order order = new Order("T5", UUID.randomUUID(), List.of(item1, item2, item3), System.currentTimeMillis(), OrderStatus.PAID, "cashier5", 0L, 0L, 0L, "");
        int sumQty = order.getItems().stream().mapToInt(OrderItem::getQuantity).sum();
        double sumPrice = order.getItems().stream().mapToDouble(i -> i.getQuantity() * i.getPriceAtOrder()).sum();
        assertEquals(3, sumQty);
        assertEquals(0*5.0 + 0*7.5 + 3*8.0, sumPrice, 0.0001);
    }
} 